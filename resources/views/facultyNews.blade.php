 ...
 <!-- page content -->
                               ...
                               @endif
                                   <div class="panel-body">
                                     <div class="row">
                                       ...
                                       @if($new->image_name)
                                       <img src="{{URL::asset('/images/News/')}}/{{$new->image_name }}" class="img-responsive avatar-view" alt="avatar">
                                       @endif
                                       <h5><span class="profile_label">Title:</span>{{$new->title}}</h5>
                                       </div>
                                     </div>
         ...
         <div id="researchAlert" class="modal">
           ...
           <div class="modal-content">
             ...
             <h4>Add some news!</h4>
             <p>Currently, you do not have any active news. Once they have been created, you will see them here.</p>
           </div>
         </div>
